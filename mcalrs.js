    ...
    <script type="text/javascript">
        ...
        function rmDisp() {
            ...
            do {
                ...
                if (rmcalLang == "my-Mon" || rmcalLang == "my-mon") rLang = 2; //Unicode Mon language
                else if (rmcalLang == "UniMon" || rmcalLang == "UniMon") rLang = 4; //UniMon Mon language
                else if (rmcalLang == "Mon" || rmcalLang == "Mon") rLang = 5; //Mon Mon language
                ...
                //--------------------------------------------------------------------
                ormcal.style.textDecoration = "none";
                ormcal.href = "#https://conkyimon.blogspot.com/";
        ...
        function rj2m(jd) {
            ...
            s = 29.5 + t * yo.bw / 5;
            c = 117 + t * yo.bw * 14 / 5; //get rate and offset
            ...
            mml = 30 - mm % 2;
            if (mm == 3) mml += yo.bw; //get length of the month and adjust
        ...
        function rSetLang(lang) //Internationalization---------------------------------
        {
            ...
            } else if (lang == 4) { //Catalog for Mon Language using UniMon,
                //Mon Language added by: 'ITVilla' : http://it-villa.blogspot.com/,
                return {
                    'First Waso': 'ဂိတုပ-ဒၢိဳန္',
                    'Tagu': 'ဂိတုစဲ',
                    'Kason': 'ဂိတုပသာ္',
                    'Nayon': 'ဂိတုေဇွ္',
                    'Waso': 'ဂိတုဒၢိဳန္',
                    ...
                    'Tawthalin': 'ဂိတုဘတ္',
                    'Thadingyut': 'ဂိတုဝွ္',
                    'Tazaungmon': 'ဂိတုကၳိဳန္',
                    'Nadaw': 'ဂိတုေျမကၠသဪု',
                    'Pyatho': 'ဂိတုေပွာ္',
                    'Tabodwe': 'ဂိတုမာ္',
                    'Tabaung': 'ဂိတုဖဝ္ရဂိုန္',
                    'waxing': 'မံက္',
                    'waning': 'ေစြက္',
                    'full moon': 'ေပင္',
                    'new moon': 'အိုတ္',
            ...
            } else if (lang == 5) { //Catalog for Mon Language using Mon,
                //Mon Language added by: 'ITVilla' : http://it-villa.blogspot.com/,
                return {
                    'First Waso': 'ဂိတုပ-ဒၢိဳန္',
                    'Tagu': 'ဂိတုစဲ',
