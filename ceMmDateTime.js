...
static cal_holiday(jdn) {
	...
	if(jdn==(atn+1)) {hs.push("Myanmar New Year's ");}
	if ((my+mmt)>=BGNTG) {
	...
	if((gy>=2018) && (gm==1) && (gd==1)) {hs.push("New Year's ");}
	else if((gy>=1948) && (gm==1) && (gd==4)) {hs.push("Independence ");}
	else if((gy>=1947) && (gm==2) && (gd==12)) {hs.push("Union ");}
	else if((gy>=1958) && (gm==3) && (gd==2)) {hs.push("Peasants' ");}
	else if((gy>=1945) && (gm==3) && (gd==27)) {hs.push("Resistance ");}
	else if((gy>=1923) && (gm==5) && (gd==1)) {hs.push("Labour ");}
	else if((gy>=1947) && (gm==7) && (gd==19)) {hs.push("Martyrs' ");}
	else if((gy>=1752) && (gm==12) && (gd==25)) {hs.push("Christmas ");}
	else if((gy==2017) && (gm==12) && (gd==30)) {hs.push("Holiday");}
	else if((gy>=2017) && (gm==12) && (gd==31)) {hs.push("Holiday");}
	else if((gy>=2017) && (gm==12) && (gd==28)) {hs.push("တ္ၚဲသၟတ်မန်");}
	//---------------------------------
	// holidays on myanmar calendar
	if((mm==2) && (mp==1)) {hs.push("Buddha ");}//Vesak day
	...
	else if((my>=1282) && (mm==8) && (md==25)) {hs.push("National ");}
	else if((mm==10) && (md==1)) {hs.push("Karen New Year's ");}
...
static cal_holiday2(jdn) {
	...
	if((gy<=2017) && (gm==1) && (gd==1)) {hs.push("New Year's ");}
	else if((gy>=1915) && (gm==2) && (gd==13)) {hs.push("G. Aung San BD");}
	else if((gy>=1969) && (gm==2) && (gd==14)) {hs.push("Valentines ");}
	else if((gy>=1970) && (gm==4) && (gd==22)) {hs.push("Earth ");}
	else if((gy>=1392) && (gm==4) && (gd==1)) {hs.push("April Fools' ");}
	else if((gy>=1948) && (gm==5) && (gd==8)) {hs.push("Red Cross ");}
	else if((gy>=1994) && (gm==10) && (gd==5)) {hs.push("World Teachers' ");}
	else if((gy>=1947) && (gm==10) && (gd==24)) {hs.push("United Nations ");}
	...
	if((my>=1309) && (mm==11) && (md==16))
		{hs.push("တ္ၚဲကောန်ဂကူမန် ");}//the ancient founding of Hanthawady
	else if((mm==9) && (md==1)) {
		hs.push("Shan New Year's ");
		if(my>=1306) {hs.push("Authors' ");}
	}//Nadaw waxing moon 1
	else if((mm==3) && (mp==1)) {hs.push("Mahathamaya ");}//Nayon full moon
	else if((mm==6)&&(mp==1)){hs.push("Garudhamma ");}//Tawthalin full moon
	else if((my>=1356) && (mm==10) && (mp==1))
		{hs.push("Mothers' ");}//Pyatho full moon
	else if((my>=1370) && (mm==12) && (mp==1))
		{hs.push("Fathers' ");}//Tabaung full moon
	else if((mm==5) && (mp==1)) {hs.push("Metta ");}//Waguang full moon
...
static Init() {
    return [
        ...
        ["Good Friday", "သောကြာနေ့ကြီး", "ေသာၾကာေန႔ႀကီး", "တ္ၚဲသ္ၚိသဝ်ဇၞော်", "ဢၼ်လီဝၼ်းသုၵ်", "မုၢ်ဖီဖး"],
        ["New Year's", "နှစ်ဆန်း", "ႏွစ္ဆန္း", "လှာဲသၞာံ", "ပီမႂ်ႇ", "နှစ်ဆန်း"],
        ["Independence", "လွတ်လပ်ရေး", "လြတ္လပ္ေရး", "တ္ၚဲသၠးပွး", "ဢၼ်လွတ်ႈလႅဝ်", "လွတ်လပ်ရေး"],
        ["Union", "ပြည်ထောင်စု", "ျပည္ေထာင္စု", "တ္ၚဲကၟိန်ဍုၚ်", "ၸိုင်ႈမိူင်းႁူမ်ႈတုမ်ႊ", "ပြည်ထောင်စု"],
        ["Peasants'", "တောင်သူလယ်သမား", "ေတာင္သူလယ္သမား", "တ္ၚဲသၟာဗ္ၚ", "ၸဝ်ႈႁႆႈၸဝ်ႈၼႃး", "တောင်သူလယ်သမား"],
        ["Resistance", "တော်လှန်ရေး", "ေတာ္လွန္ေရး", "တ္ၚဲပၠန်ဂတးဗၟာ", "လွင်ႈလုၵ်ႉၽိုၼ်", "တော်လှန်ရေး"],
        ["Labour", "အလုပ်သမား", "အလုပ္သမား", "တ္ၚဲသၟာကမၠောန်", "ၵူၼ်းႁဵတ်းၵၢၼ်", "အလုပ်သမား"],
        ["Martyrs'", "အာဇာနည်", "အာဇာနည္", "တ္ၚဲအာဇာနဲ", "ၽူႈႁတ်းငၢၼ်", "အာဇာနည်"],
        ["Christmas", "ခရစ္စမတ်", "ခရစၥမတ္", "တ္ၚဲခရေဿမာတ်", "ပွႆးၶရိတ်ႉသမတ်ႉၸ်", "ခရံာ်အိၣ်ဖျဲၣ်မူးပွဲန့ၣ်"],
        ["Buddha", "ဗုဒ္ဓ", "ဗုဒၶ", "တ္ၚဲသ္ဘၚ်ဖဍာ်ဇြဲ", "ပုတ်ႉထ", "ဗုဒ္ဓ"],
        ...
        ["Tazaungdaing", "တန်ဆောင်တိုင်", "တန္ေဆာင္တိုင္", "တ္ၚဲသ္ဘၚ်ပူဇဴပၟတ်ပၞာၚ်", "တန်ဆောင်တိုင်", "တန်ဆောင်တိုင်"],
        ["National", "အမျိုးသား", "အမ်ိဳးသား", "တ္ၚဲကောန်ဂကူ", "ၵူၼ်းမိူင်", "အမျိုးသား"],
        ["Karen", "ကရင်", "ကရင္", "တ္ၚဲကရေၚ်", "ယၢင်းၽိူၵ်ႇ", "ကရင်"],
        ["Pwe", "ပွဲ", "ပြဲ", "သ္ဘၚ်", "ပွႆ", "ပွဲ"],
        ["Thingyan", "သင်္ကြန်", "သၾကၤန္", "တ္ၚဲအတး", "သၢင်းၵျၢၼ်ႇ", "သင်္ကြန်"],
        ...
        ["Amyeittasote", "အမြိတ္တစုတ်", "အၿမိတၱစုတ္", "တ္ၚဲကိုန်အမြိုတ်", "အမြိတ္တစုတ်", "အမြိတ္တစုတ်"],
        ["Warameittugyi", "ဝါရမိတ္တုကြီး", "ဝါရမိတၱဳႀကီး", "တ္ၚဲကိုန်ဝါရမိတ္တုဇၞော်", "ဝါရမိတ္တုကြီး", "ဝါရမိတ္တုကြီး"],
        ["Warameittunge", "ဝါရမိတ္တုငယ်", "ဝါရမိတၱဳငယ္", "တ္ၚဲကိုန်ဝါရမိတ္တုဍောတ်", "ဝါရမိတ္တုငယ်", "ဝါရမိတ္တုငယ်"],
        ["Thamaphyu", "သမားဖြူ", "သမားျဖဴ", "တ္ၚဲကိုန်လေၚ်ဒိုက်", "သမားဖြူ", "သမားဖြူ"],
        ["Thamanyo", "သမားညို", "သမားညိဳ", "တ္ၚဲကိုန်ဟုံဗြမ်", "သမားညို", "သမားညို"],
        ["Yatpote", "ရက်ပုပ်", "ရက္ပုပ္", "တ္ၚဲကိုန်လီုလာ်", "ရက်ပုပ်", "ရက်ပုပ်"],
        ["Yatyotema", "ရက်ယုတ်မာ", "ရက္ယုတ္မာ", "တ္ၚဲကိုန်ယုတ်မာ", "ရက်ယုတ်မာ", "ရက်ယုတ်မာ"],
        ["Mahayatkyan", "မဟာရက်ကြမ်း", "မဟာရက္ၾကမ္း", "တ္ၚဲကိုန်ဟွံခိုဟ်", "မဟာရက်ကြမ်း", "မဟာရက်ကြမ်း"],
        ["Nagapor", "နဂါးပေါ်", "နဂါးေပၚ", "တ္ၚဲနာ်မံက်", "နဂါးပေါ်", "နဂါးပေါ်"],
        ["Shanyat", "ရှမ်းရက်", "ရွမ္းရက္", "တ္ၚဲဒတန်", "ရှမ်းရက်", "ရှမ်းရက်"],
        ["M0n", "မွန်", "မြန္", "မန်", "မွၼ်း", "မွန်"],
        ["G. Aung San BD", "ဗိုလ်ချုပ်မွေးနေ့", "ဗိုလ္ခ်ဳပ္ေမြးေန႔", "တ္ၚဲသၟိၚ်ဗၟာ အံၚ်သာန်ဒှ်မၞိဟ်", "ဝၼ်းၵိူတ်ၸွမ်သိုၵ်", "ဗိုလ်ချုပ်မွေးနေ့"],
        ["Valentines", "ချစ်သူများ", "ခ်စ္သူမ်ား", "တ္ၚဲဝုတ်ဗၠာဲ", "ၵေႃႈႁၵ်ႉ", "ချစ်သူများ"],
        ["Earth", "ကမ္ဘာမြေ", "ကမၻာေျမ", "တ္ၚဲဂၠးကဝ်", "လိၼ်မိူင်း", "ကမ္ဘာမြေ"],
        ["April Fools'", "ဧပြီအရူး", "ဧၿပီအ႐ူး", "တ္ၚဲသ္ပပရအ်", "ဢေႇပရႄႇၵူၼ်းယွင်ႇ", "အ့ဖြ့ၣ် fool"],
        ["Red Cross", "ကြက်ခြေနီ", "ၾကက္ေျခနီ", "တ္ၚဲဇိုၚ်ခ္ဍာ်ဍာဲ", "ဢၼ်မီးသီလႅင်ႁၢင်ႈၶႂၢႆႇၶႃပေ", "ကြက်ခြေနီ"],
        ["United Nations", "ကုလသမ္မဂ္ဂ", "ကုလသမၼဂၢ", "တ္ၚဲကုလသမ္မဂ္ဂ", "ဢၼ်ၽွမ်ႉႁူမ်ႈၸိူဝ်ႉၶိူဝ်းၼမ်", "ကုလသမ္မဂ္ဂ"],
        ["Halloween", "သရဲနေ့", "သရဲေန႔", "တ္ၚဲဟေဝ်လဝ်ဝိန်", "ဝၼ်းၽဵတ်", "သရဲနေ့"],
        ["Shan", "ရှမ်း", "ရွမ္း", "တ္ၚဲသေံ", "တႆး", "ရှမ်း"],
        ["Mothers'", "အမေများ", "အေမမ်ား", "တ္ၚဲမိအံက်", "မႄႈ", "မိၢ်အ"],
        ["Fathers'", "အဖေများ", "အေဖမ်ား", "တ္ၚဲမအံက်", "ပေႃ", "ပၢ်အ"],
        ...
        ["Mahathamaya", "မဟာသမယ", "မဟာသမယ", "တ္ၚဲမဟာသမယ", "ဢၼ်ယႂ်ႇၽွမ်ႉႁူမ်ႈ", "မဟာသမယ"],
        ["Garudhamma", "ဂရုဓမ္မ", "ဂ႐ုဓမၼ", "တ္ၚဲဂရုဓမ္မ", "ဂရုဓမ္မ", "ဂရုဓမ္မ"],
        ["Metta", "မေတ္တာ", "ေမတၱာ", "တ္ၚဲမေတ္တာ", "မႅတ်ႉတႃႇ", "မေတ္တာ"],
        ["Taungpyone", "တောင်ပြုန်း", "ေတာင္ျပဳန္း", "တ္ၚဲတောင်ပြုန်း", "တောင်ပြုန်း", "တောင်ပြုန်း"],
        ["Yadanagu", "ရတနာ့ဂူ", "ရတနာ့ဂူ", "တ္ၚဲရတနာ့ဂူ", "ရတနာ့ဂူ", "ရတနာ့ဂူ"],
        ["Authors'", "စာဆိုတော်", "စာဆိုေတာ္", "တ္ၚဲပြိုင်လိခ်", "ၽူႈတႅမ်ႈၽႅၼ်", "စာဆိုတော်"],
        ["World", "ကမ္ဘာ့", "ကမၻာ့", "တ္ၚဲကမ္ဘာ့", "လူၵ်", "ကမ္ဘာ့"],
        ["Teachers'", "ဆရာများ", "ဆရာမ်ား", "တ္ၚဲအစာဂမၠိုင်", "ၶူးသွၼ်", "ဆရာများ"],
        ["Holiday", "ရုံးပိတ်ရက်", "႐ုံးပိတ္ရက္", "တ္ၚဲမာတ်ရုင်", "ဝၼ်းပိၵ်ႉလုမ်း", "ရုံးပိတ်ရက်"],
        ["Chinese", "တရုတ်", "တ႐ုတ္", "တ္ၚဲကြုက်", "ၵူၼ်းၸၢဝ်းၶေ", "တရုတ်"],
        ["Easter", "ထမြောက်ရာနေ့", "ထေျမာက္ရာေန႔", "တ္ၚဲထမြောက်ရာနေ့", "ပၢင်ႇပွႆးၶွပ်ႈၶူပ်ႇၸဝ်ႈၶရိတ်", "ထမြောက်ရာနေ့"], 
		["0","၀","၀","၀","0","၀"],
		["1","၁","၁","၁","1","၁"],
		["2","၂","၂","၂","2","၂"],
		["3","၃","၃","၃","3","၃"],
		...
		["တ္ၚဲသၟတ်မန်", "တ္ၚဲသၟတ်မန် ", "တ္ၚဲသၟတ်မန် ", "တ္ၚဲသၟတ်မန် ","တ္ၚဲသၟတ်မန် ","တ္ၚဲသၟတ်မန် "],
		["Myanmar ","၊ ","၊ ","ဗၟာ ","၊ ","၊ "],	
		["တ္ၚဲကောန်ဂကူမန်","၊ ","၊ ","တ္ၚဲကောန်ဂကူမန် ","၊ ","၊ "],	
		//[", ","၊ ","၊ ","၊ ","၊ ","၊ "],	
		//[", ","၊ ","၊ ","၊ ","၊ ","၊ "],	
	];
}
